                        ...
                        if x[0] > 50:
                            ...
                            if (ratio > 0.4) and (ratio < 1.2):
                                ...
                                if ratio_array[0] > 0.5:
                                    ...
                                    print('心拍：残り数ステップです')
                                elif ratio_array[5] > 0.5 and ratio_array[4] == 0:
                                    print('心拍：残り5ステップです')
                                elif ratio_array[4] > 0.5 and ratio_array[3] == 0:
                                    print('心拍：残り4ステップです')
                                elif ratio_array[3] > 0.5 and ratio_array[2] == 0:
                                    print('心拍：残り3ステップです')
                                elif ratio_array[2] > 0.5 and ratio_array[1] == 0:
                                    print('心拍：残り2ステップです')
                                elif ratio_array[1] > 0.5 and ratio_array[0] == 0:
                                    print('心拍：残り1ステップです')
